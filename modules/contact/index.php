...
add_shortcode('contact_form','alcf_shortcode');
/**
...
function alcf_enqueue_scripts() {
    ...
    wp_register_script('alcf-validate', MODULE_PATH . 'contact/' . 'validate.js', array('jquery'), false, true);
		...
		<div id="alcf-contactform-wrap">
			<form action="'. get_permalink() .'" method="post" id="alcf-contactform">
				...
				<div class="alcf-submit">
					<input type="submit" name="Submit" id="alcf_contact" class="button tiny radius" value="Send">
